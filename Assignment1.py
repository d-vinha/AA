...
# (dropping the Id column - index 13)
corr_matrix = filtered_train_data.drop(filtered_train_data.columns[13],
                                       axis=1).corr()
...
scatter_matrix = pd.plotting.scatter_matrix(filtered_train_data,
                                            figsize=(20, 20))
plt.show()
